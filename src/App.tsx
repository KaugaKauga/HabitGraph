    ...
    <div className="flex flex-col h-full justify-center">
      <div className="flex justify-between mb-8">
        <Link className="link" to="/settings">
          <img src={gearSixDark} alt="Settings" className="size-[1.2em]" />
        </Link>
        <Link className="link text-sand-300" to="/statistics">
          <img src={chartBarDark} alt="Statistics" className="size-[1.2em]" />
        </Link>
        <Link className="link" to="/create-habit">
          <img src={plusDark} alt="Add Category" className="size-[1.2em]" />
        </Link>
      </div>
